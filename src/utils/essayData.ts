...
// For now, we'll simulate the data based on the markdown file we have
const essayData: Record<string, Essay> = {
  interpretability_for_science: {
    metadata: {
...
## References 
<span id="ref-1">[1] Wikipedia contributors. (2025). Mechanistic interpretability. Wikipedia. [https://en.wikipedia.org/wiki/Mechanistic_interpretability](https://en.wikipedia.org/wiki/Mechanistic_interpretability)</span>

<span id="ref-2">[2] Adams, E., Bai, L., Lee, M., Yu, Y., & AlQuraishi, M. (2025). From Mechanistic Interpretability to Mechanistic Biology: Training Sparse Autoencoders to Identify Interpretable Features in Protein Language Models. bioRxiv preprint doi: [https://doi.org/10.1101/2025.02.06.636901](https://doi.org/10.1101/2025.02.06.636901)</span>

<span id="ref-3">[3] Anthropic. (2024). Mapping the Mind of a Large Language Model. Anthropic Research. [https://www.anthropic.com/research/mapping-mind-language-model](https://www.anthropic.com/research/mapping-mind-language-model)</span>

<span id="ref-4">[4] Wikipedia contributors. (2025). Neuro-symbolic AI. Wikipedia. [https://en.wikipedia.org/wiki/Neuro-symbolic_AI](https://en.wikipedia.org/wiki/Neuro-symbolic_AI)</span>

<span id="ref-5">[5] Zou, A., et al. (2023). Representation Engineering: A Top-Down Approach to AI Transparency. [https://arxiv.org/abs/2310.01405](https://arxiv.org/abs/2310.01405)</span>

<span id="ref-6">[6] Kempner Institute. (2025). Mechanistic Interpretability: A Challenge Common to Both Artificial and Biological Intelligence. Kempner Institute Research. [https://kempnerinstitute.harvard.edu/research/deeper-learning/mechanistic-interpretability-a-challenge](https://kempnerinstitute.harvard.edu/research/deeper-learning/mechanistic-interpretability-a-challenge)</span>

<span id="ref-7">[7] SpringerLink. (2024). Explaining AI through Mechanistic Interpretability. Minds and Machines. [https://link.springer.com/article/10.1007/s13194-024-00614-4](https://link.springer.com/article/10.1007/s13194-024-00614-4)</span>`,
...
export async function getAllEssays(): Promise<Essay[]> {
  ...
  return Object.values(essayData);
} 